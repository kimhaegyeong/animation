...
import windowBuilder02.parkinglotView;
...
public class ParkinglotView extends JFrame {
	...
	public ParkinglotView() {
		...
		// lift 렌더링
		BorderColor liftARendering = new BorderColor(table, parkingLot.getLiftA()[0] + 1, parkingLot.getLiftA()[1],
				Color.red, new Insets(15, 0, 0, 0));
		BorderColor Renderingring = new BorderColor(table, parkingLot.getLiftB()[0] + 1, parkingLot.getLiftB()[1],
				Color.red, new Insets(15, 0, 0, 0));
		BorderColor liftCColor = new BorderColor(table, parkingLot.getLiftC()[0] + 1, parkingLot.getLiftC()[1],
				Color.red, new Insets(15, 0, 0, 0));
