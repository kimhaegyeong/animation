...
public class CellBorderTableExample06 extends JFrame {

	public CellBorderTableExample06() {
	...
	public static void main(String[] args) {
		CellBorderTableExample06 frame = new CellBorderTableExample06();
		...
		ButtonPanel(JTable table, ThicknessPanel thicknessPanel) {
			...
			b_and.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					setCellBorder(true, false, 3, 3, Color.blue, new Insets(0, 0, 3, 0));
