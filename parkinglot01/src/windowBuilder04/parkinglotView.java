...
import windowBuilder04.CellBorderTableExample.MyData;
...
public class parkinglotView extends JFrame {
	...
	public parkinglotView() {
		 ...
		 * 
		 * BorderCellRenderer[] renderers = new BorderCellRenderer[1];
		 * renderers[0] = createRenderer(Color.blue, new Insets(0, 0, 3, 0));
		 * 
		 * TableColumnModel model = table.getColumnModel();
		 * model.getColumn(4).setCellRenderer(renderers[0]);
		 */
	...
	// 컬럼 단위
	/*
	private static void createRenderer(Color color, Insets insets) {		
	...
	public class CustomTableCellRenderer extends DefaultTableCellRenderer {
		public Component getTableCellRendererComponent(JTable table,
			...
			*/
			...
			setCellBorder(false, false, 3, 3, Color.blue, new Insets(0, 0, 3, 0));
			
			
			return cell;
		}
		
		private void setCellBorder(boolean isReplace, boolean isBlock, int row, int column, Color color, Insets insets) {
