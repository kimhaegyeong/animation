...
import windowBuilder09_SWingTimerConlict.ParkingLot.Plate;
...
public class ParkinglotView extends JFrame {
		...
		public void setTimer() {
			...
			ActionListener action = new ActionListener() {
				...
				public void actionPerformed(ActionEvent event) {
					...
					liftRendering(parkingLot.getLiftB(),
							new Insets(15, 0, 0, 0));

					if (i >= departLocation[0]
							&& (parkingLot.getLiftB()[0] - departLocation[0]) > 0) {
						parkingLot.setLiftB(i--, parkingLot.getLiftB()[1]);
	...
	class MovePlate {
		...
		public MovePlate(Plate minRoutePlate2) {
			this.minRoutePlate = minRoutePlate2;
			...
			ActionListener action = new ActionListener() {
				...
				public void actionPerformed(ActionEvent event) {
					if (moveingPlate[1] == seletedPlate[1] ) {
						...
						int[] temp = new int[] { moveingPlate[0], moveingPlate[1] };
						...
						parkingLot.getState()[temp[0]][temp[1]] = parkingLot.getState()[moveingPlate[0]][moveingPlate[1]];
						parkingLot.getState()[moveingPlate[0]][moveingPlate[1]]  = null;
					...
					System.out.println(">>"  + moveingPlate[1]);
				}
			};
