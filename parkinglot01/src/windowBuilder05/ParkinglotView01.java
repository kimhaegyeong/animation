...
public class ParkinglotView01 extends JFrame {
	...
	public ParkinglotView01() {
		...
		PlateColor plateColor = new PlateColor(table, 4, 3);
...
*/
	...
	class PlateColor {
		...
		PlateColor(JTable table, int row, int column) {
			this.table = table;
			setCellBorder(true, false, row, column, Color.blue, new Insets(0, 0, 3, 0));
		}
